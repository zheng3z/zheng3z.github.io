          ...
          <ul className="menu">
            <li>
              <NavLink
                ...
                to="/home"
                tag={Link}
                activeStyle={{ fontWeight: "bold", color: "#2ab0ee" }}
            ...
            <li>
              <NavLink
                ...
                to="/education"
                tag={Link}
                activeStyle={{ fontWeight: "bold", color: "#eb6559" }}
                style={{ borderRadius: 5, color: theme.text }}
              >
                Education
              </NavLink>
            ...
            {/*    to="/experience"*/}
            {/*    tag={Link}*/}
            {/*    activeStyle={{ fontWeight: "bold" , color: "#f7b908"}}*/}
            {/*    style={{ borderRadius: 5, color: theme.text }}*/}
            {/*  >*/}
            {/*    Experience*/}
            {/*  </NavLink>*/}
            ...
            <li>
              <NavLink
                ...
                to="/projects"
                tag={Link}
                activeStyle={{ fontWeight: "bold", color: "#e44160" }}
                style={{ borderRadius: 5, color: theme.text }}
              >
                Projects
              </NavLink>
